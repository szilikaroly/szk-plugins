...
<!--
tool: tripod-ai
name: TRIPOD+AI (reporting completeness for prediction model studies)
engine: checklist.py
answers: Present|Partial|Missing
verdicts: Present|Partial|Missing
published_items: 52
unit: MANUSCRIPT
use_for: checking whether a prediction-model paper reports enough to be judged — reporting completeness, NOT quality
